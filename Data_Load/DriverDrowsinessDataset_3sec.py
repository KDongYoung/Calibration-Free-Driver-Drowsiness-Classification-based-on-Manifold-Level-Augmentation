...
class DriverDrowsiness():
    def __init__(self, args, root_path, SUBJECT_LIST):
        ...
        drowsy_num=0
        alert_num=0
        ORI_DATA=io.loadmat(root_path+'unbalanced_dataset.mat') # data
        ...
        for i in range(1, subjnum+1):
            ...
            self.datasets.append(EEGDataset(x[idx], label.squeeze()[idx], i))
